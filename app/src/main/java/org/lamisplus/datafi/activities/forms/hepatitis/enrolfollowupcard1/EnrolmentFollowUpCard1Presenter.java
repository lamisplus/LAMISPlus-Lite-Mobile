...
public class EnrolmentFollowUpCard1Presenter extends LamisBasePresenter implements EnrolmentFollowUpCard1Contract.Presenter {

    private final EnrolmentFollowUpCard1Contract.View pmtctInfoView;
    private String patientId;

    public EnrolmentFollowUpCard1Presenter(EnrolmentFollowUpCard1Contract.View pmtctInfoView, String patientId) {
