...
public abstract class NeurotechBaseActivity extends Activity {
    ...
    protected void showProgress(final String message) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mProgressDialog = ProgressDialog.show(NeurotechBaseActivity.this, "", message);
            }
        });
    }
    ...
    protected void showToast(final String message) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ToastManager.show(NeurotechBaseActivity.this, message);
            }
        });
    }
