...
public class PMTCTProgramActivity extends LamisBaseActivity {

    public PMTCTProgramContract.Presenter mPresenter;
    public PMTCTProgramFragment PMTCTProgramFragment;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pmtct_program);

        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(getContext());
        getLastLocation();

        PMTCTProgramFragment = (PMTCTProgramFragment) getSupportFragmentManager().findFragmentById(R.id.pmtctProgramContentFrame);
        if (PMTCTProgramFragment == null) {
            PMTCTProgramFragment = PMTCTProgramFragment.newInstance();
        }
        if (!PMTCTProgramFragment.isActive()) {
            addFragmentToActivity(getSupportFragmentManager(), PMTCTProgramFragment, R.id.pmtctProgramContentFrame);
        }
        ...
        if (queryBundle != null) {
            ...
            mPresenter = new PMTCTProgramPresenter(PMTCTProgramFragment, query);
        }else{
            mPresenter = new PMTCTProgramPresenter(PMTCTProgramFragment);
        }
