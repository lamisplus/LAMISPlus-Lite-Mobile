...
public class BiometricsRecaptureFragment extends LamisBaseFragment<BiometricsRecaptureContract.Presenter> implements BiometricsRecaptureContract.View, View.OnClickListener, SearchView.OnQueryTextListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_biometrics_recapture, container, false);
        if (root != null) {
    ...
    public static BiometricsRecaptureFragment newInstance() {
        return new BiometricsRecaptureFragment();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.mSecugenView:
                ...
                secugenProgram.putExtra(ApplicationConstants.BundleKeys.PATIENT_ID_BUNDLE, String.valueOf(mPresenter.getPatientId()));
                secugenProgram.putExtra(ApplicationConstants.BundleKeys.BIOMETRICS_RECAPTURE, true);
                startActivity(secugenProgram);
                break;
            case R.id.mFutronicView:
                Intent futronicProgram = new Intent(getContext(), MultiModalActivity.class);
                futronicProgram.putExtra(ApplicationConstants.BundleKeys.PATIENT_ID_BUNDLE, String.valueOf(mPresenter.getPatientId()));
                futronicProgram.putExtra(ApplicationConstants.BundleKeys.BIOMETRICS_RECAPTURE, true);
