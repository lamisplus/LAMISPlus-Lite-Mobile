...
public class FormDisplayFragment extends LamisBaseFragment<FormDisplayContract.Presenter.PagePresenter> implements FormDisplayContract.View.PageView {
    ...
    public static FormDisplayFragment newInstance() {
        return new FormDisplayFragment();
    }

    public static Fragment getInstance(int position, String title) {
        Bundle bundle = new Bundle();
        bundle.putInt("pos", position);
        FormDisplayFragment tabFragment = new FormDisplayFragment();
        posSection = position;
