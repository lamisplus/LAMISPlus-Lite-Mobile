...
public class HTSProgramRecyclerViewAdapter extends RecyclerView.Adapter<HTSProgramRecyclerViewAdapter.PatientViewHolder> {
    private HTSProgramFragment mContext;
    ...
    public HTSProgramRecyclerViewAdapter(HTSProgramFragment context, List<Person> items){
    ...
    class PatientViewHolder extends RecyclerView.ViewHolder {
        ...
        void update(final Person value) {
            ...
            itemView.setOnClickListener(view -> {
                if (!multiSelect) {
                    Intent intent = new Intent(mContext.getActivity(), HTSServicesActivity.class);
