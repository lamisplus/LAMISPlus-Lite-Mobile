...
public class FormDisplayClientIntakeFragment extends Fragment {
    ...
    public static FormDisplayClientIntakeFragment newInstance() {
        return new FormDisplayClientIntakeFragment();
    }

    public static Fragment getInstance(int position, String title) {
        Bundle bundle = new Bundle();
        bundle.putInt("pos", position);
        FormDisplayClientIntakeFragment tabFragment = new FormDisplayClientIntakeFragment();
        posSection = position;
