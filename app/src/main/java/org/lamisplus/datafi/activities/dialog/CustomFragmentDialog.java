...
package org.lamisplus.datafi.activities.dialog;
...
import org.lamisplus.datafi.activities.login.LoginFragment;
import org.lamisplus.datafi.activities.patientdashboard.PatientDashboardActivity;
import org.lamisplus.datafi.application.CustomDialogBundle;
...
//
//    private ArrayList<Person> itemsToDelete = new ArrayList<>();
//
...
//                if (LamisPlus.getInstance().getServerUrl().equals(ApplicationConstants.EMPTY_STRING)) {
//                    LamisPlus.getInstance().getLamisPlusLogger().d("Exit application");
...
//                LamisPlus.getInstance().getResources().getDisplayMetrics());
//
...
//    }
//
//    private RecyclerView addRecycleView(List<Person> patientsList, Person newPatient) {
...
//                    break;
//                case LOGOUT:
//                    ((LamisBaseActivity) getActivity()).logout();
//                    dismiss();
//                    break;
//                case FINISH:
...
//                    break;
//                case UNAUTHORIZED:
//                    ((LamisBaseActivity) getActivity()).moveUnauthorizedUserToLoginScreen();
//                    dismiss();
//                    break;
...
////                    ToastUtil.showShortToast(getContext(), ToastUtil.ToastType.SUCCESS, R.string.multiple_patients_deleted);
////                    break;
//                default:
//                    break;
//            }
