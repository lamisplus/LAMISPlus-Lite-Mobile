...
public class InfantRegistrationPresenter extends LamisBasePresenter implements InfantRegistrationContract.Presenter {
    ...
    private final InfantRegistrationContract.View pmtctInfoView;
    private String patientId;

    public InfantRegistrationPresenter(InfantRegistrationContract.View pmtctInfoView, String patientId) {
