...
public final class FingerPreferences extends PreferenceActivity {
    ...
    public static final String DETECT_LIVENESS = "single_frame_liveness_mode";
    ...
    public static void updateClient(NBiometricClient client, Context context) {
        ...
        client.setFingersDetectLiveness(preferences.getBoolean(DETECT_LIVENESS, false));
    }
    ...
    public static boolean isDetectLiveness(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context).getBoolean(DETECT_LIVENESS, false);
    }
