...
public class WithBiometricsPatientsServerRecyclerViewAdapter extends RecyclerView.Adapter<WithBiometricsPatientsServerRecyclerViewAdapter.PatientViewHolder> {
    private WithBiometricsPatientsServerFragment mContext;
    private List<Person> mItems;
    private boolean multiSelect = false;
    private ArrayList<Person> selectedItems = new ArrayList<>();

    public WithBiometricsPatientsServerRecyclerViewAdapter(WithBiometricsPatientsServerFragment context, List<Person> items) {
