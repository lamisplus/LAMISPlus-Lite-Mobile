...
public class SyncStatusRecyclerViewAdapter extends RecyclerView.Adapter<SyncStatusRecyclerViewAdapter.PatientViewHolder> {
    private SyncStatusFragment mContext;
    ...
    public SyncStatusRecyclerViewAdapter(SyncStatusFragment context, List<Person> items){
    ...
    public void onBindViewHolder(@NonNull PatientViewHolder holder, int position) {
        ...
        holder.mSyncStatus.setText("Not Synced");
    }
    ...
    class PatientViewHolder extends RecyclerView.ViewHolder {
        ...
        public PatientViewHolder(View itemView) {
            ...
            mSyncStatus = itemView.findViewById(R.id.syncedStatus);
